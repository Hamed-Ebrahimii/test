...
export default function Login() {
  ...
  return (
    <main className="w-full h-screen flex justify-center items-center px-xs sm:px-0">
      <div className="w-full sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-7/12 flex justify-center">
        <section className="rounded-sm py-24 px-14 bg-white w-5/12 shadow-card">
        ...
        <div className="shadow-card"><BackGround/></div>
      </div>
    </main>
  );
}
